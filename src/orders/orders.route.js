...
const app = express();
app.use(cors({ origin: "https://www.aawadom.com" }));
...
router.post("/create-checkout-session", async (req, res) => {
  ...
  try {
    ...
    const data = {
      ...
      mode: "payment",
      products: lineItems,
      success_url: "https://www.aawadom.com/SuccessRedirect?client_reference_id=" + nowId,
      cancel_url: "https://www.aawadom.com/cancel",
      metadata: {
